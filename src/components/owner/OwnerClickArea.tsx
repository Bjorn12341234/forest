...
function getOwnerAccent(): string {
  return getComputedStyle(document.documentElement).getPropertyValue('--color-owner-accent').trim() || '#5B9E6F'
}
    ...
    <div className="flex flex-col items-center gap-4">
      ...
      <div ref={containerRef} className="relative my-2">
        ...
        <motion.button
          ...
          style={{
            background: 'radial-gradient(circle at 40% 35%, rgba(91,158,111,0.2) 0%, rgba(91,158,111,0.06) 70%, transparent 100%)',
