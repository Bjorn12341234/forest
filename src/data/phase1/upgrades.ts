...
export const PHASE1_UPGRADES: UpgradeData[] = [
  ...
  // ── Donor Network Tree (costs CASH) ──
  {
    ...
    production: 0.5,
    maxCount: 1,
    effects: [{ type: 'cashPerSecond', value: 0.5 }],
    unlockAt: { resource: 'cash', threshold: 50 },
    phase: 1,
  },
  {
    id: 'donor_superpac',
  ...
  },
  {
    ...
    production: 5,
    maxCount: 1,
    effects: [{ type: 'cashPerSecond', value: 3 }],
  ...
  },
  {
    ...
    production: 12,
    maxCount: 1,
    effects: [{ type: 'cashPerSecond', value: 5 }, { type: 'attentionPerSecond', value: 4 }],
  ...
  },
  {
    ...
    production: 30,
    maxCount: 1,
    effects: [{ type: 'gpsMultiplier', value: 1.25 }, { type: 'cashPerSecond', value: 10 }],
  ...
  // ── Legal Defense Tree (costs CASH) ──
  {
    ...
    production: 0.8,
    maxCount: 1,
    effects: [{ type: 'attentionPerSecond', value: 1 }],
    unlockAt: { resource: 'cash', threshold: 75 },
    phase: 1,
  },
  {
    id: 'legal_dream_team',
    ...
    production: 3,
    maxCount: 1,
    effects: [{ type: 'attentionPerSecond', value: 3 }],
  ...
  },
  {
    ...
    production: 15,
    maxCount: 1,
    effects: [{ type: 'attentionPerSecond', value: 6 }, { type: 'cashPerSecond', value: 3 }],
  ...
  },
  {
    ...
    production: 35,
    maxCount: 1,
    effects: [{ type: 'gpsMultiplier', value: 1.2 }, { type: 'attentionPerSecond', value: 10 }],
